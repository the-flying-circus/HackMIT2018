...
class User(UserMixin, db.Model):
    ...
    def __repr__(self):
        return 'User(id={}, social_id={}, nickname={}, email={}, is_mentor={}, access_token={})'.format(self.id, self.social_id, self.nickname, self.email, self.is_mentor, self.access_token)
